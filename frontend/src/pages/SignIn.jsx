      ...
      >
        ...
        <div className='text-center mb-4 relative'>
          ...
          <p className='text-cyan-300/80 text-xs font-mono tracking-wider'>
            AUTHENTICATE VIRTUAL ASSISTANT PROTOCOL
          </p>
        ...
        >
          {loading ? (
            ...
            <div className='relative'>
              <span className='relative z-10'>ACCESS AI TERMINAL</span>
        ...
        {/* Sign Up Link with Robotic Styling */}
        <p className='text-cyan-300/80 text-xs text-center font-mono tracking-wider'>
          NEW PROTOCOL REQUIRED?{' '}
          <span 
            className='text-cyan-400/80 hover:text-cyan-400 cursor-pointer font-bold transition-colors duration-300 underline-offset-2 hover:underline' 
